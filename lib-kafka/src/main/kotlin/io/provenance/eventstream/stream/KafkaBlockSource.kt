...
open class KafkaBlockSource(consumerProps: Map<String, Any>, topic: String) : BlockSource<KafkaStreamBlock<String, StreamBlockImpl>> {
    private val serializationProps = mapOf<String, Any>(
        ...
        ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG to KafkaDeserializer::javaClass,
    )

    private val incoming = kafkaChannel<String, StreamBlockImpl>(consumerProps + serializationProps, setOf(topic))
