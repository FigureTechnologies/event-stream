...
const val EXPECTED_HISTORICAL_BLOCK_COUNT = (MAX_HISTORICAL_BLOCK_HEIGHT - MIN_HISTORICAL_BLOCK_HEIGHT) + 1

const val EXPECTED_NONEMPTY_BLOCKS: Long = 29

const val EXPECTED_EMPTY_BLOCKS = EXPECTED_HISTORICAL_BLOCK_COUNT - EXPECTED_NONEMPTY_BLOCKS

val heights: List<Long> = (MIN_HISTORICAL_BLOCK_HEIGHT..MAX_HISTORICAL_BLOCK_HEIGHT).toList()

const val COMBO_TOTAL_NONEMPTY_BLOCK_COUNT = EXPECTED_LIVE_TOTAL_BLOCK_COUNT + EXPECTED_HISTORICAL_BLOCK_COUNT
